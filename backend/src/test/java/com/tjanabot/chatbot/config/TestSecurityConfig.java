...
public class TestSecurityConfig {
    ...
    private com.tjanabot.chatbot.security.RateLimitingFilter rateLimitingFilter;
    
    @org.springframework.beans.factory.annotation.Autowired(required = false)
    private com.tjanabot.chatbot.security.JwtAuthenticationFilter jwtAuthenticationFilter;
    
    @org.springframework.beans.factory.annotation.Autowired(required = false)
    private com.tjanabot.chatbot.security.AnonymousAuthenticationPreFilter anonymousAuthenticationPreFilter;
