...
if [ -z "$ANTHROPIC_API_KEY" ]; then
    echo "⚠️  Warning: ANTHROPIC_API_KEY is not set. Chat functionality will be limited."
    echo "   Set your Anthropic API key: export ANTHROPIC_API_KEY=your-key-here"
fi

if [ -z "$OPENAI_API_KEY" ]; then
    echo "⚠️  Warning: OPENAI_API_KEY is not set. Embedding functionality will be limited."
